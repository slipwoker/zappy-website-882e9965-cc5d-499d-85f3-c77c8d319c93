document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (minLength && value.length < parseInt(minLength, 10)) {
        showFieldError(field, getErrorMessage('minlength', field, minLength));
        isValid = false;
        if (!firstInvalidField) firstInvalidField = field;
        return;
      }
      ...
      if (maxLength && value.length > parseInt(maxLength, 10)) {
        showFieldError(field, getErrorMessage('maxlength', field, maxLength));
        isValid = false;
        if (!firstInvalidField) firstInvalidField = field;
      }
    });
  ...
  function getErrorMessage(type, field, extra) {
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        const newElements = node.matches && node.matches(OBSERVED_SELECTOR)
          ? [node]
          : Array.from(node.querySelectorAll ? node.querySelectorAll(OBSERVED_SELECTOR) : []);

        if (node.matches && node.matches(OBSERVED_SELECTOR)) {
          newElements.unshift(node);
        }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '882e9965-cc5d-499d-85f3-c77c8d319c93',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '882e9965-cc5d-499d-85f3-c77c8d319c93';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '882e9965-cc5d-499d-85f3-c77c8d319c93';
